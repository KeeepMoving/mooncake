...
//		}
 ...
 // /user/showUser2?id=1
    ...
    public String toIndex2(@RequestParam("id") String id,Model model) throws Exception{  
    ...
    public String toIndex3(@PathVariable("id")String id,Map<String, Object> model) throws Exception{  
        int userId = Integer.parseInt(id);  
        System.out.println("userId:"+userId);
        User user = this.userService.getUserById(userId);  
        log.debug(user.toString());
 ...
 // /user/{id}
    ...
    public @ResponseBody User getUserInJson(@PathVariable String id,Map<String, Object> model) throws Exception{  
        int userId = Integer.parseInt(id);  
        System.out.println("userId:"+userId);
        User user = this.userService.getUserById(userId);  
    ...
    public ResponseEntity<User>  getUserInJson2(@PathVariable String id,Map<String, Object> model) throws Exception{  
        int userId = Integer.parseInt(id);  
        System.out.println("userId:"+userId);
        User user = this.userService.getUserById(userId);  
        log.info(user.toString());
